 ...
 * @since		1.6
 */
class UsersModelUser_Man_Order_Items extends JModelList
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery()
	{
		...
		// Join over the users for the business user.
		$query->select('bu.name AS user_business_name');
		$query->join('LEFT', '#__users AS bu ON bu.id=a.business_id');
