...
class upload
{
	...
	public static function files($field, $uploadPath, $newName = null, $thumb = false, $uploadPathThumbs = null, $thumbName = null)
	{
		...
		{
			$result[$key] = upload::file($file['jform'], $field, $uploadPath, $newName[$key], $thumb, $uploadPathThumbs, $thumbName);
		}
	...
	public static function file($file, $field, $uploadPath, $newName = null, $thumb = false, $uploadPathThumbs = null, $thumbName = null)
	{
		...
		$validFileExts = explode(',', 'jpeg,jpg,png,gif,swf');
		...
		$okMIMETypes = 'image/jpeg,image/pjpeg,image/png,image/x-png,image/gif,image/x-ms-bmp,application/x-shockwave-flash';
		...
		else 
		{
			if($thumb)
			{
		        ...
		        //$thumb->resize(135, 186);
		        //die(CFG_THUMBNAIL_WIDTH_ISSUE . ' x ' .CFG_THUMBNAIL_HEIGHT_ISSUE);
		        $thumb->resize(CFG_THUMBNAIL_WIDTH_ISSUE, CFG_THUMBNAIL_HEIGHT_ISSUE);
