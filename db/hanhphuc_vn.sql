...
--
-- Host: localhost
-- Generation Time: Oct 11, 2012 at 04:25 AM
...
--
-- Database: `hanhphuc_vn`
--

-- --------------------------------------------------------

--
-- Table structure for table `hp_assets`
--
...
--
-- Dumping data for table `hp_assets`
--

INSERT INTO `hp_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Table structure for table `hp_associations`
--

CREATE TABLE IF NOT EXISTS `hp_associations` (
...
CREATE TABLE IF NOT EXISTS `hp_banners` (
...
--
-- Table structure for table `hp_banner_clients`
--

CREATE TABLE IF NOT EXISTS `hp_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `hp_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `hp_banner_tracks` (
...
CREATE TABLE IF NOT EXISTS `hp_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `hp_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`) VALUES
...
--
-- Table structure for table `hp_contact_details`
--

CREATE TABLE IF NOT EXISTS `hp_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `hp_content`
--
...
--
-- Table structure for table `hp_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `hp_content_frontpage` (
...
--
-- Table structure for table `hp_content_rating`
--

CREATE TABLE IF NOT EXISTS `hp_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `hp_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `hp_core_log_searches` (
...
--
-- Table structure for table `hp_extensions`
--

CREATE TABLE IF NOT EXISTS `hp_extensions` (
...
--
-- Dumping data for table `hp_extensions`
--

INSERT INTO `hp_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
--
-- Table structure for table `hp_finder_filters`
--

CREATE TABLE IF NOT EXISTS `hp_finder_filters` (
...
--
-- Table structure for table `hp_finder_links`
--

CREATE TABLE IF NOT EXISTS `hp_finder_links` (
...
--
-- Table structure for table `hp_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `hp_finder_links_terms0` (
...
--
-- Table structure for table `hp_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `hp_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `hp_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `hp_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `hp_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `hp_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `hp_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `hp_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `hp_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `hp_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `hp_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `hp_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `hp_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `hp_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `hp_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `hp_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `hp_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `hp_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `hp_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `hp_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `hp_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `hp_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `hp_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `hp_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `hp_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `hp_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `hp_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `hp_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `hp_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `hp_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `hp_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `hp_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `hp_finder_taxonomy`
--

INSERT INTO `hp_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `hp_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `hp_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `hp_finder_terms`
--

CREATE TABLE IF NOT EXISTS `hp_finder_terms` (
...
--
-- Table structure for table `hp_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `hp_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Dumping data for table `hp_finder_terms_common`
--

INSERT INTO `hp_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `hp_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `hp_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `hp_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `hp_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `hp_finder_types`
--

CREATE TABLE IF NOT EXISTS `hp_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `hp_languages`
--

CREATE TABLE IF NOT EXISTS `hp_languages` (
...
--
-- Dumping data for table `hp_languages`
--

INSERT INTO `hp_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
...
INSERT INTO `hp_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `ordering`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Table structure for table `hp_menu_types`
--

CREATE TABLE IF NOT EXISTS `hp_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `hp_menu_types`
--

INSERT INTO `hp_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Table structure for table `hp_messages`
--
...
--
-- Table structure for table `hp_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `hp_messages_cfg` (
...
--
-- Table structure for table `hp_modules`
--

CREATE TABLE IF NOT EXISTS `hp_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `hp_modules`
--

INSERT INTO `hp_modules` (`id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Table structure for table `hp_modules_menu`
--

CREATE TABLE IF NOT EXISTS `hp_modules_menu` (
...
--
-- Dumping data for table `hp_modules_menu`
--

INSERT INTO `hp_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `hp_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `hp_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `hp_overrider`
--

CREATE TABLE IF NOT EXISTS `hp_overrider` (
...
--
-- Table structure for table `hp_redirect_links`
--

CREATE TABLE IF NOT EXISTS `hp_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `hp_schemas`
--

CREATE TABLE IF NOT EXISTS `hp_schemas` (
...
--
-- Dumping data for table `hp_schemas`
--

INSERT INTO `hp_schemas` (`extension_id`, `version_id`) VALUES
(700, '2.5.7');

-- --------------------------------------------------------

--
-- Table structure for table `hp_session`
--
...
--
-- Dumping data for table `hp_session`
--

INSERT INTO `hp_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`, `usertype`) VALUES
('0r03j04egptnsdm6ec3la28ml5', 1, 0, '1349921312', '__default|a:8:{s:15:"session.counter";i:4;s:19:"session.timer.start";i:1349921302;s:18:"session.timer.last";i:1349921306;s:17:"session.timer.now";i:1349921306;s:22:"session.client.browser";s:99:"Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.4 (KHTML, like Gecko) Chrome/22.0.1229.92 Safari/537.4";s:8:"registry";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":2:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:0:"";}s:13:"com_installer";O:8:"stdClass":2:{s:7:"message";s:0:"";s:17:"extension_message";s:0:"";}}}s:4:"user";O:5:"JUser":25:{s:9:"\0*\0isRoot";b:1;s:2:"id";s:3:"427";s:4:"name";s:10:"Super User";s:8:"username";s:5:"admin";s:5:"email";s:23:"nguyenxuanmui@gmail.com";s:8:"password";s:65:"0a27164f55a4ea56d70560461ab623d5:qvcvjWcj1n05wDjXJUQjArqKKfJZZBqJ";s:14:"password_clear";s:0:"";s:8:"usertype";s:10:"deprecated";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2012-10-11 02:08:14";s:13:"lastvisitDate";s:19:"0000-00-00 00:00:00";s:10:"activation";s:1:"0";s:6:"params";s:0:"";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:10:"\0*\0_params";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:14:"\0*\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\0*\0_authLevels";a:4:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;}s:15:"\0*\0_authActions";N;s:12:"\0*\0_errorMsg";N;s:10:"\0*\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"de723ab84d420ae99eb4de14c3bf961e";}', 427, 'admin', '');

-- --------------------------------------------------------

--
-- Table structure for table `hp_template_styles`
--

CREATE TABLE IF NOT EXISTS `hp_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `hp_template_styles`
--

INSERT INTO `hp_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `hp_updates`
--

CREATE TABLE IF NOT EXISTS `hp_updates` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Available Updates' AUTO_INCREMENT=71 ;

--
-- Dumping data for table `hp_updates`
--

INSERT INTO `hp_updates` (`update_id`, `update_site_id`, `extension_id`, `categoryid`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`) VALUES
...
(18, 3, 0, 0, 'Flemish', '', 'pkg_nl-BE', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/nl-BE_details.xml', ''),
...
(21, 3, 0, 0, 'Japanese', '', 'pkg_ja-JP', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/ja-JP_details.xml', ''),
(22, 3, 0, 0, 'Serbian Latin', '', 'pkg_sr-YU', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/sr-YU_details.xml', ''),
(23, 3, 0, 0, 'Arabic Unitag', '', 'pkg_ar-AA', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/ar-AA_details.xml', ''),
(24, 3, 0, 0, 'German', '', 'pkg_de-DE', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/de-DE_details.xml', ''),
(25, 3, 0, 0, 'Norwegian Bokmal', '', 'pkg_nb-NO', 'package', '', 0, '2.5.7.2', '', 'http://update.joomla.org/language/details/nb-NO_details.xml', ''),
(26, 3, 0, 0, 'Norwegian Bokmal', '', 'pkg_nb-NO', 'package', '', 0, '2.5.7.2', '', 'http://update.joomla.org/language/details/nb-NO_details.xml', ''),
(27, 3, 0, 0, 'English AU', '', 'pkg_en-AU', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/en-AU_details.xml', ''),
(28, 3, 0, 0, 'English AU', '', 'pkg_en-AU', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/en-AU_details.xml', ''),
(29, 3, 0, 0, 'English US', '', 'pkg_en-US', 'package', '', 0, '2.5.7.2', '', 'http://update.joomla.org/language/details/en-US_details.xml', ''),
(30, 3, 0, 0, 'English US', '', 'pkg_en-US', 'package', '', 0, '2.5.7.2', '', 'http://update.joomla.org/language/details/en-US_details.xml', ''),
(31, 3, 0, 0, 'Serbian Cyrillic', '', 'pkg_sr-RS', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/sr-RS_details.xml', ''),
(32, 3, 0, 0, 'Lithuanian', '', 'pkg_lt-LT', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/lt-LT_details.xml', ''),
(33, 3, 0, 0, 'Albanian', '', 'pkg_sq-AL', 'package', '', 0, '2.5.1.5', '', 'http://update.joomla.org/language/details/sq-AL_details.xml', ''),
(34, 3, 0, 0, 'Albanian', '', 'pkg_sq-AL', 'package', '', 0, '2.5.1.5', '', 'http://update.joomla.org/language/details/sq-AL_details.xml', ''),
(35, 3, 0, 0, 'Persian', '', 'pkg_fa-IR', 'package', '', 0, '2.5.7.2', '', 'http://update.joomla.org/language/details/fa-IR_details.xml', ''),
(36, 3, 0, 0, 'Persian', '', 'pkg_fa-IR', 'package', '', 0, '2.5.7.2', '', 'http://update.joomla.org/language/details/fa-IR_details.xml', ''),
(37, 3, 0, 0, 'Galician', '', 'pkg_gl-ES', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/gl-ES_details.xml', ''),
(38, 3, 0, 0, 'Galician', '', 'pkg_gl-ES', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/gl-ES_details.xml', ''),
(39, 3, 0, 0, 'Polish', '', 'pkg_pl-PL', 'package', '', 0, '2.5.7.2', '', 'http://update.joomla.org/language/details/pl-PL_details.xml', ''),
(40, 3, 0, 0, 'Syriac', '', 'pkg_sy-IQ', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/sy-IQ_details.xml', ''),
(41, 3, 0, 0, 'Russian', '', 'pkg_ru-RU', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/ru-RU_details.xml', ''),
(42, 3, 0, 0, 'Hebrew', '', 'pkg_he-IL', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/he-IL_details.xml', ''),
(43, 3, 0, 0, 'Hebrew', '', 'pkg_he-IL', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/he-IL_details.xml', ''),
(44, 3, 0, 0, 'Laotian', '', 'pkg_lo-LA', 'package', '', 0, '2.5.6.1', '', 'http://update.joomla.org/language/details/lo-LA_details.xml', ''),
(45, 3, 0, 0, 'Afrikaans', '', 'pkg_af-ZA', 'package', '', 0, '2.5.6.2', '', 'http://update.joomla.org/language/details/af-ZA_details.xml', ''),
(46, 3, 0, 0, 'Chinese Simplified', '', 'pkg_zh-CN', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/zh-CN_details.xml', ''),
(47, 3, 0, 0, 'Greek', '', 'pkg_el-GR', 'package', '', 0, '2.5.6.1', '', 'http://update.joomla.org/language/details/el-GR_details.xml', ''),
(48, 3, 0, 0, 'Greek', '', 'pkg_el-GR', 'package', '', 0, '2.5.6.1', '', 'http://update.joomla.org/language/details/el-GR_details.xml', ''),
(49, 3, 0, 0, 'Esperanto', '', 'pkg_eo-XX', 'package', '', 0, '2.5.6.1', '', 'http://update.joomla.org/language/details/eo-XX_details.xml', ''),
(50, 3, 0, 0, 'Esperanto', '', 'pkg_eo-XX', 'package', '', 0, '2.5.6.1', '', 'http://update.joomla.org/language/details/eo-XX_details.xml', ''),
(51, 3, 0, 0, 'Finnish', '', 'pkg_fi-FI', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/fi-FI_details.xml', ''),
(52, 3, 0, 0, 'Portuguese Brazil', '', 'pkg_pt-BR', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/pt-BR_details.xml', ''),
(53, 3, 0, 0, 'Portuguese Brazil', '', 'pkg_pt-BR', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/pt-BR_details.xml', ''),
(54, 3, 0, 0, 'Chinese Traditional', '', 'pkg_zh-TW', 'package', '', 0, '2.5.7.2', '', 'http://update.joomla.org/language/details/zh-TW_details.xml', ''),
(55, 3, 0, 0, 'Vietnamese', '', 'pkg_vi-VN', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/vi-VN_details.xml', ''),
(56, 3, 0, 0, 'Kurdish Sorani', '', 'pkg_ckb-IQ', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/ckb-IQ_details.xml', ''),
(57, 3, 0, 0, 'Kurdish Sorani', '', 'pkg_ckb-IQ', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/ckb-IQ_details.xml', ''),
(58, 3, 0, 0, 'Bosnian', '', 'pkg_bs-BA', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/bs-BA_details.xml', ''),
(59, 3, 0, 0, 'Croatian', '', 'pkg_hr-HR', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/hr-HR_details.xml', ''),
(60, 3, 0, 0, 'Azeri', '', 'pkg_az-AZ', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/az-AZ_details.xml', ''),
(61, 3, 0, 0, 'Norwegian Nynorsk', '', 'pkg_nn-NO', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/nn-NO_details.xml', ''),
(62, 3, 0, 0, 'Norwegian Nynorsk', '', 'pkg_nn-NO', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/nn-NO_details.xml', ''),
(63, 3, 0, 0, 'Tamil India', '', 'pkg_ta-IN', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/ta-IN_details.xml', ''),
(64, 3, 0, 0, 'Scottish Gaelic', '', 'pkg_gd-GB', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/gd-GB_details.xml', ''),
(65, 3, 0, 0, 'Thai', '', 'pkg_th-TH', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/th-TH_details.xml', ''),
(66, 3, 0, 0, 'Basque', '', 'pkg_eu-ES', 'package', '', 0, '1.7.0.1', '', 'http://update.joomla.org/language/details/eu-ES_details.xml', ''),
(67, 3, 0, 0, 'Uyghur', '', 'pkg_ug-CN', 'package', '', 0, '2.5.6.1', '', 'http://update.joomla.org/language/details/ug-CN_details.xml', ''),
(68, 3, 0, 0, 'Korean', '', 'pkg_ko-KR', 'package', '', 0, '2.5.7.2', '', 'http://update.joomla.org/language/details/ko-KR_details.xml', ''),
(69, 3, 0, 0, 'Hindi', '', 'pkg_hi-IN', 'package', '', 0, '2.5.6.1', '', 'http://update.joomla.org/language/details/hi-IN_details.xml', ''),
(70, 3, 0, 0, 'Welsh', '', 'pkg_cy-GB', 'package', '', 0, '2.5.6.1', '', 'http://update.joomla.org/language/details/cy-GB_details.xml', '');

-- --------------------------------------------------------

--
-- Table structure for table `hp_update_categories`
--

CREATE TABLE IF NOT EXISTS `hp_update_categories` (
...
--
-- Table structure for table `hp_update_sites`
--

CREATE TABLE IF NOT EXISTS `hp_update_sites` (
...
--
-- Dumping data for table `hp_update_sites`
--

INSERT INTO `hp_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1349921307),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1349921307),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist.xml', 1, 1349921307);

-- --------------------------------------------------------

--
-- Table structure for table `hp_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `hp_update_sites_extensions` (
...
--
-- Dumping data for table `hp_update_sites_extensions`
--

INSERT INTO `hp_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600);
...
--
-- Table structure for table `hp_usergroups`
--

CREATE TABLE IF NOT EXISTS `hp_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Dumping data for table `hp_usergroups`
--

INSERT INTO `hp_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 20, 'Public'),
(2, 1, 6, 17, 'Registered'),
(3, 2, 7, 14, 'Author'),
(4, 3, 8, 11, 'Editor'),
...
INSERT INTO `hp_users` (`id`, `name`, `username`, `email`, `password`, `usertype`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`) VALUES
(427, 'Super User', 'admin', 'nguyenxuanmui@gmail.com', '0a27164f55a4ea56d70560461ab623d5:qvcvjWcj1n05wDjXJUQjArqKKfJZZBqJ', 'deprecated', 0, 1, '2012-10-11 02:08:14', '2012-10-11 02:08:25', '0', '', '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Table structure for table `hp_user_notes`
--

CREATE TABLE IF NOT EXISTS `hp_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `hp_user_profiles`
--
...
--
-- Table structure for table `hp_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `hp_user_usergroup_map` (
...
--
-- Dumping data for table `hp_user_usergroup_map`
--

INSERT INTO `hp_user_usergroup_map` (`user_id`, `group_id`) VALUES
(427, 8);

-- --------------------------------------------------------

--
-- Table structure for table `hp_viewlevels`
--

CREATE TABLE IF NOT EXISTS `hp_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `hp_viewlevels`
--

INSERT INTO `hp_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Table structure for table `hp_weblinks`
--

CREATE TABLE IF NOT EXISTS `hp_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
