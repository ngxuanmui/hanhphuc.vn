...
ALTER TABLE `hp_users` ADD COLUMN `user_type` INT(3) NOT NULL DEFAULT 0  AFTER `params` ;

CREATE  TABLE `hp_hp_business_profile` (
  `user_id` INT NULL ,
...
CREATE TABLE `hp_hp_business_info` (
...
CREATE TABLE `hp_hp_business_service` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `hp_hp_business_promotion` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `business_id` int(11) NOT NULL,
  `category` int(11) NOT NULL,
...
CREATE  TABLE `hp_hp_order_items` (
  `id` INT NOT NULL AUTO_INCREMENT ,
