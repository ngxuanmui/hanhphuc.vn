 ...
 * @since		1.5
 */
class WeddingViewApp extends JViewLegacy
{
	protected $form;
	protected $item;
	protected $state;
	...
	protected function addToolbar()
	{
		...
		$canDo		= WeddingHelper::getActions($this->item->catid,0);

		JToolBarHelper::title($isNew ? JText::_('App Manager: New') : JText::_('App Manager: Edit'), 'banners.png');
