 ...
 * @since		1.5
 */
class je_faqTableFaq extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__je_faqs', 'id', $_db);
	...
	function store($updateNulls = false)
	{
		...
		{
			// Get the old row
			$oldrow = JTable::getInstance('Faq', 'je_faqTable');
	...
	public function publish($pks = null, $state = 1, $userId = 0)
	{
		...
		$table = JTable::getInstance('Faq','je_faqTable');
